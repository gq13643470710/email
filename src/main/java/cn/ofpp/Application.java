...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        // new 一个 女友
        GirlFriend girlFriend = new GirlFriend("小郭",
                "山西省", "太原市", "1998-07-30", "1998-07-30", "qin1203759206");
        Wx.sendTemplateMessage(MessageFactory.resolveMessage(girlFriend));

//        // new 一个 男友 也可单独针对一个friend设置模板ID 以达到不同人不同消息
        BoyFriend boyFriend = new BoyFriend("小高",
                "山西省", "太原市", "1998-06-09", "1998-07-30", "wxid_yy803gh9fm0d22");
